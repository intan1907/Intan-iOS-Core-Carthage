...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Core"
  spec.version      = "1.0.0"
  spec.summary      = "Intan Core.framework for modularization exercise"
  ...
  # Or just: spec.author    = "Intan Nurjanah"
  # spec.authors            = { "Intan Nurjanah" => "intan@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Intan Nurjanah"
